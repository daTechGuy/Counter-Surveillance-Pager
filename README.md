...
Loot: `/root/loot/counter_surveillance_pager/surveillance_<ts>.txt` (Flock + Mesh-Detect hits, same line format as upstream flock-you) and `/root/loot/counter_surveillance_pager/drone_rid_<ts>.txt` (every decoded drone message: time, transport, MAC, message type, fields).
